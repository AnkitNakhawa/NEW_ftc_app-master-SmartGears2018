...
@Autonomous(name = "RoboAutonomous_Ankit", group = "pushbot")
//@disabled
public class RobtGameAutonomous_Ankit extends LinearOpMode {
...
//        }
    ...
    public void linearSlideHookRelease (double motorPower, long motorTimeValue) throws InterruptedException{
        linearSlide.setPower(-1);
        sleep(500);
        linearSlide.setPower(0);
        TurnRight(motorPower, motorTimeValue);
        MoveBackward(motorPower, motorTimeValue);

    }

    public void Sampling(double motorPower, long motorTimeValue) throws InterruptedException{
        if (hsvValues[0]>=31){
            MoveForward(motorPower, motorTimeValue);
        }
        else{
            TurnLeft(motorPower, motorTimeValue);
            MoveForward(motorPower, motorTimeValue);
            if (hsvValues[0]>=31){
                MoveForward(motorPower, motorTimeValue);
            }else{
